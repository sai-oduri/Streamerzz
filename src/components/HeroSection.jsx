  ...
  return (
    <motion.section
      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
        ...
        <motion.h1
          variants={fadeInUp}
          className="pb-2 text-5xl lg:text-8xl my-4 font-semibold tracking-tighter bg-gradient-to-b from-neutral-50 via-neutral-300 to-neutral-700 bg-clip-text text-transparent">
        ...
        <motion.p
          variants={fadeInUp}
          className="mt-4 text-neutral-400 max-w-xl">
