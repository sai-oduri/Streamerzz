    ...
    <section id="works">
      <div className="max-w-7xl mx-auto px-4">
        <motion.div
          ...
          <h2 className="text-3xl lg:text-5xl mt-20 tracking-tighter bg-gradient-to-t from-neutral-50 via bg-neutral-300 to-neutral-600 bg-clip-text text-transparent">
